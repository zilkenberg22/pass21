...
export default function PlusButton({ onClick }) {
  return (
    <button
      className="h-[64px] w-[64px] cursor-pointer bg-[#feeb29] rounded-full border-[3px] border-[#242424] shadow-lg flex items-center justify-center fixed right-24 bottom-14"
      onClick={() => onClick()}
    >
      <svg
        class="sc-hLBbgP jxEncj sc-fEXmlR"
        width="31.72"
        height="31.72"
        viewBox="0 0 32 32"
      >
